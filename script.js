...
const sound2 = new Audio('./assets/e.mp3')
const sound3 = new Audio('./assets/mouse-click-104737.mp3')


function greet(username, time) {
  const greetingtext = `Good ${time}, ${username}! Welcome to the Rock Paper Scissors game!`;
...
let glassbead = document.createElement('img');
glassbead.src = './assets/glass bead.jpg';
glassbead.width = 200;
glassbead.height = 200;



if (computer_choice === choice) {
  alert(`Player chose ${choice}, Computer chose ${computer_choice} . It's a draw!`);
  document.getElementById('rps').appendChild(glassbead);
